...
<div id="header">
  ...
  <dl class="funcs">
    ...
    <dt>
      <form id="searchForm" name="searchForm" method="post" action="psearch.html" onsubmit="return checkSearchFormAction();">
        <input class="text" name="keywords" id="so_txt" type="text" value="" placeholder="请输入查询的商品" autocomplete="off" />
...
<script type="text/javascript">
	$(function(){
		...
		//主页广告位查询
		$.ajax({
			url:"<%=request.getContextPath()%>/goodsController/goodslist1.do",
			//data:"",
			type:"post",
			datatype:"json",
			async:false,
