...
public class HttpClient {
    ...
    public static String togetString(String userphone) throws IOException {
        ...
        params.put("accountSid","0f47353f304042a8b655c87977c10d11");
        params.put("templateid","208176258");
        ...
        params.put("sig",Md5Util.getMd532(params.get("accountSid").toString()+"f66be8cede3f404b8949a62a020b1f45"+params.get("timestamp").toString()));
