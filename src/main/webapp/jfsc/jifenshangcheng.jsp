...
<script type="text/javascript">
	...
	for (var i = 0; i < pager.length; i++) {
		...
		tr+="<div style='float:left' ><img src='"+pager[i].image+"'  width='200px' height='200px' title='点击查看详细信息' onclick='chakanxx("+pager[i].sid+",\""+pager[i].sname+"\")' >&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<br><span><font size='1'>"+pager[i].sname+"</font></span><br><span><font size='1'>价格："+pager[i].sprice+"积分 </font></span></div>"
